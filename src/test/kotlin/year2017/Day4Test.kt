...
object Day4Test : Spek({
    given("a day 4 High-Entropy Passphrases") {
        ...
        val input4 = "oaoe rxeq vssdqtu xrk cjv yaoqp loo\n" +
    ...
    given("a day 4 Complex High-Entropy Passphrases") {
        ...
        val input6 = "oaoe rxeq vssdqtu xrk cjv yaoqp loo\n" +
                "mveua dogbam szydvri hyzk lbega abzqw xwjn wniug kwbre\n" +
                "npaoy uivpxwd oynpa rcdk uixpvdw\n" +
                "yserir iikzcm ieuroca iuwcfov rvb giti crdpdcv mxpps\n" +
                "spyuhgo lucasl ucllsa bymnjig yflbv nxitmlf\n" +
        ...
        on("the input $input6") {
            val result = 512
            it("is $result") {
                Assertions.assertThat(day.doItBetter(input6)).isEqualTo(result)
            }
        }
    }
})